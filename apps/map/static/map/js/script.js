...
require([
  ...
  "dojo/domReady!"
], function (Map, MapView, Search, Popup, watchUtils, query,
  on, dom, FeatureLayer, UniqueValueRenderer, SimpleMarkerSymbol, SimpleLineSymbol, SimpleFillSymbol, Legend, Print) {
    ...
    var schoolsplanrenderer = new UniqueValueRenderer({
      ...
      field: "F16_SPF_PLAN",
      legendOptions: {
        title: "SPF Plan - 2016-17 (Preliminary)"
      }
    });
    ...
    var districtplanrenderer = new UniqueValueRenderer({
      field: "DIST_PLAN",
      legendOptions: {
        title: "DPF Plan - 2016-17 (Preliminary)"
      }
    });
    ...
    schoolstyperenderer.addUniqueValueInfo("Y", chartersymbol)
    schoolstyperenderer.addUniqueValueInfo("N", traditionalsymbol)
    ...
    var SPFColorVis = {
      ...
      field: "F16_SPF_SCORE",
      legendOptions: {
        title: "SPF Score - 2016-17 (Preliminary)"
      },
      stops: [
        {
          value: .2,
    ...
    var FRLSizeVis = {
      ...
      stops: [
        { value: .01, size: 3, label: "1% FRL" },
        { value: .25, size: 10, label: "25% FRL" },
    ...
    ******************************************************************/
    ...
    var schoolspopup = { // autocasts as new PopupTemplate()
      title: "{SCHOOL_NAME}",
      content: "{ADDRESS}, {CITY}, CO" +
        ...
        "<li><p1>2016-17 SPF Rating:</p1> {F16_SPF_PLAN}</li>" +
        "<li><p1>2016-17 SPF Score:</p1> {F16_SPF_SCORE: percentformat}</li>" +
    ...
    var censustractspopup = { // autocasts as new PopupTemplate()
      title: "{NAMELSAD}",
      content: "<ul><li><p1>Population:</p1> {TOT_POP}</li>" +
        ...
        "<li><p1>Quality MS Seat Need:</p1> {MI_NEED}</li>" +
    ...
    var districtspopup = { // autocasts as new PopupTemplate()
      title: "{NAME}",
      content: "<ul><li><p1>DPF Plan:</p1> {DIST_PLAN}</li>" +
        "<li><p1>DPF Score:</p1> {DIST_DPFSC}/100</li>" +
        "<li><p1>PPR (excludes MLO):</p1> {PPR: currencyformat}</li>" +
    ...
    var citiespopup = { // autocasts as new PopupTemplate()
      title: "{NAME}, CO",
      content: "<ul><li><p1>Population:</p1> {TOT_POP}</li>" +
    ...
    var housepopup = { // autocasts as new PopupTemplate()
      title: "{NAMELSAD}",
    };

    var congressionalpopup = { // autocasts as new PopupTemplate()
    ...
    ******************************************************************/
    ...
    var districts = new FeatureLayer({
      url: "https://services8.arcgis.com/i7OPmUoTPHFfRStk/arcgis/rest/services/districts/FeatureServer",
    ...
    var schools = new FeatureLayer({
      url: "https://services8.arcgis.com/i7OPmUoTPHFfRStk/arcgis/rest/services/Schools/FeatureServer",
    ...
    ******************************************************************/
    ...
    $(document).ready(function () {
      ...
      $("#selectElementary, #selectMiddle, #selectHigh, #selectTurnaround, #selectPriorImprov, #selectImprov, #selectPerformance, #selectTPS, #selectCharters, #sliderFRL, #sliderMinority, #sliderELL, #sliderIEP, #includeAEC, #excludeAEC, #AECOnly, #sliderSPF").on("change", function () {

        //build out expression for school grade level//

        if ($("#selectElementary").is(':checked') || $("#selectMiddle").is(':checked') || $("#selectHigh").is(':checked')) {
          string += "(";
        ...
        if ($("#selectTurnaround").is(':checked') || $("#selectPriorImprov").is(':checked') || $("#selectImprov").is(':checked') || $("#selectPerformance").is(':checked')) {
          ...
          if ($("#selectTurnaround").is(':checked')) {
            if (count != 0) {
              string += " OR F16_SPF_PLAN = 'Turnaround'";
            } else {
              string += " F16_SPF_PLAN = 'Turnaround'";
              count += 1
            }
          }
          ...
          if ($("#selectPriorImprov").is(':checked')) {
            if (count != 0) {
              string += " OR F16_SPF_PLAN = 'Priority Improvement'";
            } else {
              string += " F16_SPF_PLAN = 'Priority Improvement'";
              count += 1
            }
          }
          ...
          if ($("#selectImprov").is(':checked')) {
            if (count != 0) {
              string += " OR F16_SPF_PLAN= 'Improvement'";
            } else {
              string += " F16_SPF_PLAN = 'Improvement'";
              count += 1
            }
          }
          ...
          if ($("#selectPerformance").is(':checked')) {
            if (count != 0) {
              string += " OR F16_SPF_PLAN = 'Performance'";
            } else {
              string += " F16_SPF_PLAN = 'Performance'";
              count += 1
            }
          }
        ...
        if (sliderSPF.value > 0) {
          ...
          if (count != 0) {
            string += " AND (F16_SPF_SCORE>" + maxSPF + ")";
          } else {
            string += "(F16_SPF_SCORE >" + maxSPF + ")";
            count += 1;
          }
        }
      ...
      function querySchools() {
        ...
        schools.queryFeatures(schoolsQuery).then(function (response) {
          ...
          for (var i = 0; i < school_list.length; i++) {
            $("#schoolData").append("<tr><td scope='row'>" + school_list[i].SCHOOL_CODE + "</td><td>" + school_list[i].SCHOOL_NAME + "</td><td>" + school_list[i].DISTRICT_NAME + "</td></tr>")
          }
        });
      }
      ...
      var originalsizeoptions = $("#styleSchoolsSize").children().clone();
      var originalcoloroptions = $("#styleSchoolsColor").children().clone();
      $("#styleSchoolsColor").on("change", function () {
        var selection = $('select[name=styleSchoolsColor]').val();
        if (selection != 3 && selection != 1) {
          var options = "<option data-textcolor='calcite-text-light' value='1' data-bgcolor='calcite-bg-dark' selected>None</option>";
      ...
      $("#styleSchoolsSize").on("change", function () {
        ...
        if (secondselection != 1) {
          var option1 = "<option data-textcolor='calcite-text-light' value='1' data-bgcolor='calcite-bg-dark' selected>None</option>"
          var option2 = "<option data-textcolor='calcite-text-light' value='3' data-bgcolor='calcite-bg-dark'>SPF Score</option>"
       ...
       ******************************************************************/
      //Change Available School Options Based on User Selection//
      var originalstyleoptions = $("#geoStyle").children().clone();
      var originalgeooptions = $("#geo").children().clone();
      var option1 = "<option value='1' data-textcolor='calcite-text-light' data-bgcolor='calcite-bg-dark'selected>Geography Only</option>"
      var option2 = "<option value='2' data-textcolor='calcite-text-light' data-bgcolor='calcite-bg-dark'>Median HH Income</option>"
      var option3 = "<option value='3' data-textcolor='calcite-text-light' data-bgcolor='calcite-bg-dark'>K-12 Poverty</option>"
      var option4 = "<option value='4' data-textcolor='calcite-text-light' data-bgcolor='calcite-bg-dark'>Quality Seats Needed - Elem</option>"
      var option5 = "<option value='5' data-textcolor='calcite-text-light' data-bgcolor='calcite-bg-dark'>Quality Seats Needed - Middle</option>"
      var option6 = "<option value='6' data-textcolor='calcite-text-light' data-bgcolor='calcite-bg-dark'>Quality Seats Needed - High</option>"
      var option7 = "<option value='7' data-textcolor='calcite-text-light' data-bgcolor='calcite-bg-dark'>Population Growth</option>"
      var option8 = "<option value='8' data-textcolor='calcite-text-light' data-bgcolor='calcite-bg-dark'>PPR</option>"
      var option9 = "<option value='9' data-textcolor='calcite-text-light' data-bgcolor='calcite-bg-dark'>District Performance Plan</option>"
