...
require([
  ...
  var schoolspopup = {
    ...
    content:
      ...
      '<li><p1>2016-17 SPF Rating:</p1> {F17_SPF_FINAL}</li>' +
      '<li><p1>2016-17 SPF Score:</p1> {F17_SPF_SCORE: percentformat}</li>' +
  ...
  $(document).ready(function() {
    ...
    $(
      '#selectElementary, #selectMiddle, #selectHigh, #selectTurnaround, #selectPriorImprov, #selectImprov, #selectPerformance, #selectTPS, #selectCharters, #sliderFRL, #sliderMinority, #sliderELL, #sliderIEP, #includeAEC, #excludeAEC, #AECOnly, #sliderSPF',
    ).on('change', function() {
